...
const FileComponent: React.FC<FileComponentProps> = ({
  ...
  useEffect(() => {}, [fileNameWithoutExtension]);
  ...
  const handleSaveClick = () => {
    ...
    const updatedFileName =
      fileNameWithoutExtension + (fileExtension ? "." + fileExtension : "");
    ...
    <>
      <ListItem button onClick={handleItemClick}>
        ...
        <ListItemText
          ...
          secondary={`Size: ${formatFileSize(file.fileSize)} | Uploaded At: ${
            file.uploadedAt
          }`}
          sx={{ mr: 10 }}
        />
        <ListItemSecondaryAction>
          ...
          <IconButton
            ...
            onClick={() => setOpenMoveToFolderDialog(true)}
            sx={{ ml: 0.8 }}
          >
            <DriveFileMove />
          </IconButton>
